...
<title>Danh sách bài đã lưu</title>
</head>
<body>
	...
	<div class="container">
		...
		<div class="row">
					<div class="navbar-header">
                            <a class="navbar-brand">Danh sách bài đã lưu</a>
                    </div>
					<form class="navbar-form navbar-left" action="${pageContext.request.contextPath}/xemDanhSachBaiVietDaLuu.do" method="get">
      						...
      						<div class="thumbnail" style="border-color: #0059b3; height:250px;">
          						<div class="caption">
            						...
            						<p><label>Số lượt thích:${baiViet.soLuotThich}</label></p>
                                     ...
                                     <button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/deleteLuuBaiViet.do?idBaiViet=${baiViet.idBaiViet}'">Xóa lưu bài viết</button>
         					    </div>
      						</div>
   					   </div>
                  	</div>
